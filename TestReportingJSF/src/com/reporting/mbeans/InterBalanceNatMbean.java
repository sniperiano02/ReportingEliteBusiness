...
@ManagedBean(name="inter_balance_nat")
@ViewScoped
public class InterBalanceNatMbean {
	
	@EJB
	private StatInterBalanceNatRemote inter_balance_service;
			 ...
			 chartDisplayed = false;
			 		...
			 		if(compJourOutputHeure!=null){
			 			...
			 			if(this.getChoix_periode().equals("Par Jour")){
			 				...
			 				ValueExpression valjour = createValueExpression("#{inter_balance_nat.date_ParJourDeb}", Date.class);
			 				...
			 				ValueExpression valjourfin = createValueExpression("#{inter_balance_nat.date_ParJourFin}", Date.class);
			 				...
			 				lstDateYears.setId("lstDateYears");
			 				 ValueExpression valueExp = createValueExpression("#{inter_balance_nat.date_year_deb}", Integer.class);
			 				...
			 				lstDateYearsFin.setId("lstDateYearsFin");
			 				 ValueExpression valueExp1 = createValueExpression("#{inter_balance_nat.date_year_fin}", Integer.class);
			 			...
			 			ValueExpression valjour = createValueExpression("#{inter_balance_nat.date_mois_debut}", Date.class);
			 			...
			 			ValueExpression valjourfin = createValueExpression("#{inter_balance_nat.date_mois_fin}", Date.class);
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(charge),SUM(nbCharge),SUM(minutesCharge)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(charge),SUM(nbCharge),SUM(minutesCharge)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(charge),SUM(nbCharge),SUM(minutesCharge)", "", where_liste);
			 	...
			 	public void Valider2(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(produit),SUM(nbProduit),SUM(minutesProduit)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit)", "", where_liste);
...
public void Valider3(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(charge),SUM(nbCharge),SUM(minutesCharge)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(charge),SUM(nbCharge),SUM(minutesCharge)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalanceNat("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(charge),SUM(nbCharge),SUM(minutesCharge)", "", where_liste);
