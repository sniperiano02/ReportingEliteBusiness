...
@ManagedBean(name="mou_roain")
@ViewScoped
public class StatMouRoamingMbean {
			 ...
			 chartDisplayed = false;
			 		...
			 		if(compJourOutputHeure!=null){
			 			...
			 			if(this.getChoix_periode().equals("Par Jour")){
			 				...
			 				ValueExpression valjour = createValueExpression("#{mou_roain.date_ParJourDeb}", Date.class);
			 				...
			 				ValueExpression valjourfin = createValueExpression("#{mou_roain.date_ParJourFin}", Date.class);
			 				...
			 				lstDateYears.setId("lstDateYears");
			 				 ValueExpression valueExp = createValueExpression("#{mou_roain.date_year_deb}", Integer.class);
			 				...
			 				lstDateYearsFin.setId("lstDateYearsFin");
			 				 ValueExpression valueExp1 = createValueExpression("#{mou_roain.date_year_fin}", Integer.class);
			 			...
			 			ValueExpression valjour = createValueExpression("#{mou_roain.date_mois_debut}", Date.class);
			 			...
			 			ValueExpression valjourfin = createValueExpression("#{mou_roain.date_mois_fin}", Date.class);
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listMouRoa = mou_service.getStatMou("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(nbMinutes),SUM(nbRoa),(SUM(nbMinutes)/SUM(nbRoa))",  where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMou("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(nbMinutes),SUM(nbRoa),(SUM(nbMinutes)/SUM(nbRoa))",   where_liste));

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMou("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(nbMinutes),SUM(nbRoa),(SUM(nbMinutes)/SUM(nbRoa))",  where_liste));
