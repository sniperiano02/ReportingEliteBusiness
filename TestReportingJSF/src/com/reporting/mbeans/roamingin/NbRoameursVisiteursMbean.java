...
@ManagedBean(name="nb_roa")
@ViewScoped
public class NbRoameursVisiteursMbean {
			 ...
			 chartDisplayed = false;
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listMouRoa = mou_service.getStatMou("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(nbMinutes),SUM(nbRoa),SUM(revenue),SUM(revenueConverti)",  where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMou("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(nbMinutes),SUM(nbRoa),SUM(revenue),SUM(revenueConverti)",   where_liste));

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMou("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(nbMinutes),SUM(nbRoa),SUM(revenue),SUM(revenueConverti)",  where_liste));
