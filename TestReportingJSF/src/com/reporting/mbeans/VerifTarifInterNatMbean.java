...
@ManagedBean(name="verif_tarif_inter_nat")
@ViewScoped
public class VerifTarifInterNatMbean {
			 ...
			 chartDisplayed = false;
			 		...
			 		if(compJourOutputHeure!=null){
			 			...
			 			if(this.getChoix_periode().equals("Par Jour")){
			 				...
			 				ValueExpression valjour = createValueExpression("#{verif_tarif_inter_nat.date_ParJourDeb}", Date.class);
			 				...
			 				ValueExpression valjourfin = createValueExpression("#{verif_tarif_inter_nat.date_ParJourFin}", Date.class);
			 				...
			 				lstDateYears.setId("lstDateYears");
			 				 ValueExpression valueExp = createValueExpression("#{verif_tarif_inter_nat.date_year_deb}", Integer.class);
			 				...
			 				lstDateYearsFin.setId("lstDateYearsFin");
			 				 ValueExpression valueExp1 = createValueExpression("#{verif_tarif_inter_nat.date_year_fin}", Integer.class);
			 			...
			 			ValueExpression valjour = createValueExpression("#{verif_tarif_inter_nat.date_mois_debut}", Date.class);
			 			...
			 			ValueExpression valjourfin = createValueExpression("#{verif_tarif_inter_nat.date_mois_fin}", Date.class);
