...
@ManagedBean(name="inter_balance")
@ViewScoped
public class InterBalanceMbean {
	
	@EJB
	private StatInterBalanceRemote inter_balance_service;
	...
	private List<Object[]> listeInterBalance;
	...
	public void setDate_year(Integer date_year) {
		...
		private String choix_typeCall;
		 ...
		 @PostConstruct
		 public void init(){
			 liste_desAns = inter_balance_service.getAllYears();
			 listeInterBalance = new ArrayList<>();
			 ...
			 chartDisplayed = false;
			 		...
			 		if(compJourOutputHeure!=null){
			 			...
			 			if(this.getChoix_periode().equals("Par Jour")){
			 				...
			 				ValueExpression valjour = createValueExpression("#{inter_balance.date_ParJourDeb}", Date.class);
			 				...
			 				ValueExpression valjourfin = createValueExpression("#{inter_balance.date_ParJourFin}", Date.class);
			 				...
			 				lstDateYears.setId("lstDateYears");
			 				 ValueExpression valueExp = createValueExpression("#{inter_balance.date_year_deb}", Integer.class);
			 				...
			 				lstDateYearsFin.setId("lstDateYearsFin");
			 				 ValueExpression valueExp1 = createValueExpression("#{inter_balance.date_year_fin}", Integer.class);
			 			...
			 			ValueExpression valjour = createValueExpression("#{inter_balance.date_mois_debut}", Date.class);
			 			...
			 			ValueExpression valjourfin = createValueExpression("#{inter_balance.date_mois_fin}", Date.class);
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalance("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)", "", where_liste);
			 	...
			 	public void Valider2(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalance("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti)", "", where_liste);
...
public void Valider3(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeInterBalance = inter_balance_service.getStatInterBalance("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti),SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti),SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			listeInterBalance = inter_balance_service.getStatInterBalance("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(produit),SUM(nbProduit),SUM(minutesProduit),SUM(produitConverti),SUM(charge),SUM(nbCharge),SUM(minutesCharge),SUM(chargeConverti)", "", where_liste);
		...
		public List<Object[]> getListeInterBalance() {
			return listeInterBalance;
		}
		public void setListeInterBalance(List<Object[]> listeInterBalance) {
			this.listeInterBalance = listeInterBalance;
		}
