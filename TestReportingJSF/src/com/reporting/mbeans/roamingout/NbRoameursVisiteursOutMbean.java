...
@ManagedBean(name="nb_roa_out")
@ViewScoped
public class NbRoameursVisiteursOutMbean {
			 ...
			 chartDisplayed = false;
			 		...
			 		if(compJourOutputHeure!=null){
			 			...
			 			if(this.getChoix_periode().equals("Par Jour")){
			 				...
			 				ValueExpression valjour = createValueExpression("#{nb_roa_out.date_ParJourDeb}", Date.class);
			 				...
			 				ValueExpression valjourfin = createValueExpression("#{nb_roa_out.date_ParJourFin}", Date.class);
			 				...
			 				lstDateYears.setId("lstDateYears");
			 				 ValueExpression valueExp = createValueExpression("#{nb_roa_out.date_year_deb}", Integer.class);
			 				...
			 				lstDateYearsFin.setId("lstDateYearsFin");
			 				 ValueExpression valueExp1 = createValueExpression("#{nb_roa_out.date_year_fin}", Integer.class);
			 			...
			 			ValueExpression valjour = createValueExpression("#{nb_roa_out.date_mois_debut}", Date.class);
			 			...
			 			ValueExpression valjourfin = createValueExpression("#{nb_roa_out.date_mois_fin}", Date.class);
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listMouRoa = mou_service.getStatMouOut("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(parc)",  where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMouOut("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(parc)",   where_liste));

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			 listMouRoa = removeDuplicate(generateList,mou_service.getStatMouOut("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(parc)",  where_liste));
