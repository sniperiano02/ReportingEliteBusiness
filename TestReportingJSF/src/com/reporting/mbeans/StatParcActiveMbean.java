...
@ManagedBean(name="parc_active")
@ViewScoped
public class StatParcActiveMbean {


@EJB
private ParcActiveRemote parcActivePrpSevice;
...
public void setListParcActive(List<Object[]> listParcActive) {
	...
	private boolean chartDisplayed =false;
		 ...
		 chartDisplayed = false;
		 	    ...
		 	    Application app = facesCtx.getApplication();
		 		 ...
		 		 if (this.getChoix_periode().equals("Par Mois")){
		 			...
		 			ValueExpression valjour = createValueExpression("#{parc_active.date_mois_debut}", Date.class);
		 			...
		 			ValueExpression valjourfin = createValueExpression("#{parc_active.date_mois_fin}", Date.class);
	 ...
	 public void Valider(){
			...
			listParcActive= parcActivePrpSevice.getStatParcActive("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", where_liste);
