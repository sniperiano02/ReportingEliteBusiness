...
@ManagedBean(name="verif_transfert")
@ViewScoped
public class VerifTransfertMbean {
	
	@EJB
	VerifTransfertRemote verif_transfert_service;
	...
	public void setDate_year(Integer date_year) {
		...
		private String choix_typeCall;
		 ...
		 @PostConstruct
		 public void init(){
			 liste_desAns = verif_transfert_service.getAllYears();
			 ...
			 chartDisplayed = false;
			 	...
			 	public void Valider(){
			 	 ...
			 	 if(this.getChoix_periode().equals("Par An")){
			 	 			 listeVerifTranfert = verif_transfert_service.getStatVerifTransfert("Extract (year from to_date(dateAppel,'YYMMDD'))", "SUM(impact),SUM(nbAppel)",  "", where_liste);
			 	 			
			 	 			
			 		 		 }else if(this.getChoix_periode().equals("Par Mois")){
			 		 			 listeVerifTranfert = verif_transfert_service.getStatVerifTransfert("to_char(to_date(dateAppel,'YYMMDD'),'MM/YYYY')", "SUM(impact),SUM(nbAppel)",  "", where_liste);

			 		 		 }else if (this.getChoix_periode().equals("Par Jour")){
			 		 			 listeVerifTranfert = verif_transfert_service.getStatVerifTransfert("to_char(to_date(dateAppel,'YYMMDD'),'DD/MM/YYYY')", "SUM(impact),SUM(nbAppel)", "", where_liste);
			 	...
			 	public void getDetail(){
			 		...
			 		listeDetailsVerifTransfert= new ArrayList<>();
			 		String where="";
			 		if(this.getChoix_periode().equals("Par Jour")){
