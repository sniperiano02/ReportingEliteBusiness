...
import com.reporting.metier.entities.StatIntecNatinterco;
...
/**
 * Session Bean implementation class StatIntecImpl
 */
@Stateless
public class StatIntecNatImpl implements StatIntecNatImplRemote {
	...
	@Override
	public List<Object[]> getIntecByFilters1(String x, String y,String table,
	...
	@Override
	public List<Object[]> getIntecByFilters(String x, String y,String table,
			String action, String groupby, List<String> Where) {
	...
	public String getStatIntec() {
		...
		return em.find(StatIntecNatinterco.class, 1).getDateAppel();
	}
	...
	public Date getIntecDate() {
		// TODO Auto-generated method stub
		return (Date) em.createQuery("SELECT to_date(dateAppel,'YYMMDD') from StatIntecNatinterco s ").getSingleResult();
	}
	...
	@Override
	public List<Object[]> getIntecBytranche(String x, String y,String table,
			String action, String groupby, List<String> Where) {
...
return em.createQuery("Select to_date(dateAppel,'YYMMDD'),SUM(duree) from StatIntecNatinterco s Group By to_date(dateAppel,'YYMMDD')  )").getResultList();
		}
...
return em.createQuery("Select to_date(dateAppel,'YYMMDD'),SUM(nbAppel) from StatIntecNatinterco s Group By to_date(dateAppel,'YYMMDD')  )").getResultList();
		}
	...
	public List<Integer> getAllYears() {
		// TODO Auto-generated method stub
		return em.createQuery("Select distinct extract(year from to_date(dateAppel,'YYMMDD'))From StatIntecNatinterco s order by extract(year from to_date(dateAppel,'YYMMDD')) ").getResultList();
	}
	...
	public List<String> getAlltrancheHoraire() {
		// TODO Auto-generated method stub
		return em.createQuery("Select distinct trancheHoraire from StatIntecNatinterco s").getResultList();
	}
	...
	@Override
	public List<Object[]> getAllStatIntec(String x, List<String> list_y,String table,
			String action, String groupby, List<String> Where) {
		...
		return em.createQuery("Select "+x+","+y+"From StatIntecNatinterco s Where  "+where+" Group By "+x+ " Order By "+x ).getResultList();
	}
	...
	@Override
	public List<Object[]> getAllStatIntec1(String x, List<AxeY> list_y,String table,
			String action, String groupby, List<String> Where) {
		String axeYOp="";
	...
	@Override
	public List<Object[]> getAllStatIntecStatic(String x, String y,
			String action, String groupby, List<String> Where) {
		// TODO Auto-generated method stub
		String where =  Where.get(0);
		if(Where.size()>=2){
		...
		if(x.contains("substring")){
			...
			Query q=  em.createQuery("Select "+x+","+y+"From StatIntecNatinterco s Where  "+where+" Group By trancheHoraire Order By CAST (trancheHoraire as integer)" );
			res=q.getResultList();
			if(!res.isEmpty()){
				return res;
			}else
			...
			Query q=  em.createQuery("Select "+x+","+y+"From StatIntecNatinterco s Where  "+where+" Group By "+x+" Order By "+x );
			res=q.getResultList();
			if(!res.isEmpty()){
				return res;
			}else
