...
import com.reporting.metier.entities.StatCentralInterconat;
 ...
 */
@Stateless
public class StatCentralNalImpl implements StatCentraleNatImplRemote {
	...
	@Override
	public List<Object[]> getCentralByFilters(String x, String y,String table,
			String action, String groupby, List<String> Where) {
	...
	public String getStatCentral() {
		...
		return em.find(StatCentralInterconat.class, 1).getDateAppel();
	}
	...
	public Date getCentralDate() {
		// TODO Auto-generated method stub
		return (Date) em.createQuery("SELECT to_date(dateAppel,'YYMMDD') from StatCentralInterconat s ").getSingleResult();
	}
	...
	@Override
	public List<Object[]> getCentralBytranche(String x, String y,String table,
			String action, String groupby, List<String> Where) {
...
return em.createQuery("Select to_date(dateAppel,'YYMMDD'),SUM(duree) from StatCentralInterconat s Group By to_date(dateAppel,'YYMMDD')  )").getResultList();
		}
...
return em.createQuery("Select to_date(dateAppel,'YYMMDD'),SUM(nbAppel) from StatCentralInterconat s Group By to_date(dateAppel,'YYMMDD')  )").getResultList();
		}
	...
	public List<Integer> getAllYears() {
		// TODO Auto-generated method stub
		return em.createQuery("Select distinct extract(year from to_date(dateAppel,'YYMMDD'))From StatCentralInterconat s order by extract(year from to_date(dateAppel,'YYMMDD')) ").getResultList();
	}
	...
	public List<String> getAlltrancheHoraire() {
		// TODO Auto-generated method stub
		return em.createQuery("Select distinct trancheHoraire from StatCentralInterconat s").getResultList();
	}
	...
	@Override
	public List<Object[]> getAllStatCentral(String x, List<String> list_y,String table,
			String action, String groupby, List<String> Where) {
		...
		return em.createQuery("Select "+x+","+y+"From StatCentralInterconat s Where  "+where+" Group By "+x+ " Order By "+x ).getResultList();
	}
	...
	@Override
	public List<Object[]> getAllStatCentral1(String x, List<AxeY> list_y,String table,
			String action, String groupby, List<String> Where) {
		String axeYOp="";
	...
	@Override
	public List<Object[]> getAllStatCentralStatic(String x, String y,
			String action, String groupby, List<String> Where) {
		// TODO Auto-generated method stub
		String where =  Where.get(0);
		if(Where.size()>=2){
		...
		if(x.contains("substring")){
			...
			Query q=  em.createQuery("Select "+x+","+y+"From StatCentralInterconat s Where  "+where+" Group By trancheHoraire Order By CAST (trancheHoraire as integer)" );
			res=q.getResultList();
			if(!res.isEmpty()){
				return res;
			}else
			...
			Query q=  em.createQuery("Select "+x+","+y+"From StatCentralInterconat s Where  "+where+" Group By "+x+" Order By "+x );
			res=q.getResultList();
			if(!res.isEmpty()){
				return res;
			}else
