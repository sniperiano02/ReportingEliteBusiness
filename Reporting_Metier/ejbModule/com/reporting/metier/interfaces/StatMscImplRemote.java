...
public interface StatMscImplRemote {
	...
	public List<Object[]> getMscBytranche(String x,String y,String table,String action,String groupby,List<String> Where);
	public List<Object[]> getMscByFilters(String x,String y,String table,String action,String groupby,List<String> Where);
...
public List<Object[]> getTest() ;
	public List<Object[]> getMscByFilters1(String x, String y,String table,String action, String groupby, List<String> Where);
