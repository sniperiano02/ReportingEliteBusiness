...
/**
 * The persistent class for the fichier_lcr2 database table.
 * 
 */
@Entity
@Table(name="fichier_lcr2",schema="tableref")
@NamedQuery(name="FichierLcr2.findAll", query="SELECT f FROM FichierLcr2 f")
public class FichierLcr2 implements Serializable {
